...
class LoginPage(BasePage):
    ...
    def should_be_login_url(self):
        ...
        assert substring in self.browser.current_url, "Slovo 'login' otsutstvuet v ssilke."

    def should_be_login_form(self):
        assert self.is_element_present(*LoginPageLocators.LOGIN_FORM), "Otsutstvuet forma logina!"
